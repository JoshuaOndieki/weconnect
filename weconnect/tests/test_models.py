...
class TestModels(unittest.TestCase):
    ...
    def test_user_instance_creation(self):
        self.user_instance = User("test_user",
                                  "test_user@email.com",
                                  "test password")
        self.assertIsInstance(self.user_instance, User,
                              msg="Instance created should be a User \
                              instance!")

    def test_business_instance_creation(self):
        self.business_instance = Business(
                                 1, "test Business", "Nairobi, Kenya",
                                 "test category", "test_user")
        self.assertIsInstance(
                              self.business_instance, Business,
                              msg="Instance created should be a \
                              Business instance!")
    ...
    def test_review_instance_creation(self):
        ...
        self.assertIsInstance(
                              ...
                              msg="Instance created should be a Review \
                              instance!")
