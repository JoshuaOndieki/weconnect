...
class TestApiEndpoints(unittest.TestCase):
    """
        ...
        Tests Business API endpoints
            ...
            - BusinessHandler:  '/api/v1/businesses/<businessId>'   # DELETE
    ...
    def test_user_registration_successful_with_acceptable_info(self):
        ...
        self.response = self.client().post('/api/v1/auth/register', data=json.dumps(data))
    ...
    def test_user_login_successful_with_matching_user_info(self):
        ...
        self.response = self.client().post('/api/v1/auth/login', data=json.dumps(data))
    ...
    def test_create_business(self):
        data = {"username": "user1", "password": "user1pass"}
        self.response = self.client().post('/api/v1/businesses', data=json.dumps(data))
        result = json.loads(self.response.data.decode())
        access_token = result['access_token']
        data = {'name': 'bs1', 'location': 'loc1', 'category': 'cat1'}
        self.response = self.client().post('/api/v1/businesses', data=json.dumps(data), headers=dict(Authorization="Bearer " + access_token))
    ...
    def test_update_a_business(self):
        ...
        self.response = self.client().put('/api/v1/businesses/1', data=json.dumps(data), headers=dict(Authorization="Bearer " + access_token))
    ...
    def test_delete_a_business(self):
        ...
        access_token = result['access_token']
        data = {'name': 'updatedbs1', 'location': 'loc1', 'category': 'cat1'}
        self.response = self.client().delete('/api/v1/businesses/1', data=json.dumps(data), headers=dict(Authorization="Bearer " + access_token))
    ...
    def test_create_business_review(self):
        ...
        self.response = self.client().post('/api/v1/businesses/1/reviews', data=json.dumps(data))
        self.assertTrue(self.response.status_code is 201)
